...
const OrgChart = dynamic(
  ...
  { ssr: false, loading: () => <div>INSERT EMPTY MOCKUP</div> },
);
      ...
      <main className="mx-auto max-w-3xl px-4 pb-4 md:max-w-5xl lg:max-w-full">
        ...
        <form className="mb-4 flex w-full items-center">
          ...
          <div className="flex w-full justify-end">
            <a
              className="mr-20 rounded-lg border border-gray-700 bg-gray-700 p-2.5 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
              href="/persons"
            >
              Persons
            </a>
